...
<form action="app.php" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" id="registro_est_form" name="registro_est_form" method="POST">
...
<div class="flex flex-wrap -mx-3 mb-6">
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="user_grade" id="user_grade" type="number" placeholder="Grado">
    </div>
    <div class="w-full md:w-1/2 px-3">
      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
      Colegio:
      </label>
      <p class="text-gray-600 text-xs italic mb-2">1 (1 grado) – 6 ( 6 grado)</p>
      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
      Liceo:
      </label>
      <p class="text-gray-600 text-xs italic mb-2">7 (1 año) – 11 (5 año)</p>
    </div>
